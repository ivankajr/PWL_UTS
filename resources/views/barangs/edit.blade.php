...
@section('content')
    <div class="container mt-5">
        ...
        <div class="card" style="width: 24rem;">
            ...
            @endif
        <form method="post" action="{{ route('barang.update', $barang->nim) }}" id="myForm">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="tanggal_lahir" name="qty" class="form-control" id="qty" value="{{ $Barang->qty }}" aria-describedby="qty" >
        </div>
